            ...
            function($http, loadServ, $timeout) {
                return {
                    ...
                    link: function(scope, element, attrs) {
                        $timeout(function() {
                            var d3 = window.d3;
                            var variance = [{'value':1,'number':0},{'value':2,'number':0},{'value':3,'number':0},{'value':4,'number':0}
                                ,{'value':5,'number':0},{'value':6,'number':0},{'value':7,'number':0}];
                            var varianceNum = 7;
                            var devMax = 0,
                                devMin = 0,
                                highest = 0;
                            ...
                            x.domain(variance.map(function(d) { return d.value; }));
                            y.domain([0, d3.max(variance, function(d) { return d.number; })]);
